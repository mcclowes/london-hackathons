...
import { devfolio } from "./sources/devfolio";
...
export const SOURCES: Source[] = [lumaDiscover, lumaCalendars, curated, devpost, mlh, eventbrite, meetup, cerebralValley, ethGlobal, lablab, devfolio];
